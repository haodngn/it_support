...
class dellform extends StatelessWidget {
  const dellform({Key? key}) : super(key: key);
...
class _DropdownControlState extends State<DropdownControl> {
  String dropdownValue = 'Laptop Dell Inspiron N3580';
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownButtonFormField<String>(
      ...
      items: <String>[
        'Laptop Dell Inspiron N3580',
        'Laptop Dell Inspiron 3580',
        'Laptop Dell Inspiron 5593 ',
        'Dell Vostro 3580 i5 8265U',
        'Dell Vostro 3580 i7 8565U',
        'Dell Vostro 3580 i5 8265U',
        'Dell XPS 13',
        'Dell XPS 15',
