...
class MacBookForm extends StatelessWidget {
  const MacBookForm({Key? key}) : super(key: key);
          ...
          children: <Widget>[
            ...
            CustomContainer(
              ...
              child: Column(
                children: <Widget>[
                  CheckboxFormField(
                    title: Text("Máy bị khởi động lại thường xuyên"),
                  ...
                  CheckboxFormField(
                    title: Text("Quạt tản nhiệt hoạt động bất thường"),
                    onSaved: (bool? newValue) {},
                    validator: (bool? value) {},
                  ),
                  RoundedInputField(
...
class _DropdownControlState extends State<DropdownControl> {
  String dropdownValue = 'Macbook Air';
